...
public class WebHttpSessionRequestCacheUnitTest
{
	...
	public void testCalcRedirectUrlWithEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/hybrisstorefront/electronics/en",
						"https://electronics.local:9002/hybrisstorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/hybrisstorefront/electronics/en",
						"https://electronics.local:9002/hybrisstorefront/electronics/en/"));
	...
	public void testCalcRedirectUrlWithMismatchEncodingAttrs()
	{
		assertEquals(
				"electronics/en",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/hybrisstorefront/electronics/ja/Y/Z",
						"https://electronics.local:9002/hybrisstorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/hybrisstorefront/electronics/en",
						"https://electronics.local:9002/hybrisstorefront/electronics/en/"));
	}
	...
	public void testCalcRedirectUrlWithoutEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/hybrisstorefront",
						"https://electronics.local:9002/hybrisstorefront"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/hybrisstorefront",
						"https://electronics.local:9002/hybrisstorefront/"));
	...
	public void testCalcRedirectUrlWithEncodingAttrsServletPath()
	{
		assertEquals(
				...
				executeCalculateRelativeRedirectUrl("electronics/en", "/hybrisstorefront/electronics/en",
						"https://electronics.local:9002/hybrisstorefront/electronics/en/Open-Catalogue/Cameras/Digital-Cameras/c/575"));
	}
