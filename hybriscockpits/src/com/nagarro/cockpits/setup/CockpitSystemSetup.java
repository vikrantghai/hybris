 ...
 *
 */
package com.nagarro.cockpits.setup;
...
import com.nagarro.cockpits.constants.HybrisCockpitsConstants;
 ...
 */
@SystemSetup(extension = HybrisCockpitsConstants.EXTENSIONNAME)
public class CockpitSystemSetup extends AbstractSystemSetup
{
	...
	public void createEssentialData(final SystemSetupContext context)
	{
		...
		{
			if (MediaManager.getInstance().getMediaFolderByQualifier(HybrisCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER).size() < 1)
			{
				MediaManager.getInstance().createMediaFolder(HybrisCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER,
						HybrisCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER);
			}
			try
			{
				String prefix = null;
				...
				if (prefix != null){
					importImpexFile(context, "/hybriscockpits/reportcockpit/import/" + prefix + "_jasperreports.impex");
				}
			}
