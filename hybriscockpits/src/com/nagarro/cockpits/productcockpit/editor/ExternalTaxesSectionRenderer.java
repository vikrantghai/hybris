 ...
 *
 */
package com.nagarro.cockpits.productcockpit.editor;
			...
			if (section instanceof CustomEditorSection)
			{
				...
				if (customSection.getSectionConfiguration() instanceof ExternalTaxesSectionConfiguration)
				{
					...
					if (secConfig != null)
					{
						...
						final Label rowLabel = new Label(Labels.getLabel("hybriscockpits.product.externalTaxes"));
						rowLabel.setTooltiptext(Labels.getLabel("hybriscockpits.product.externalTaxes"));
