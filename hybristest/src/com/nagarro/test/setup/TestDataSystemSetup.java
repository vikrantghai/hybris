...
import com.nagarro.test.constants.HybrisTestConstants;
 ...
 */
@SystemSetup(extension = HybrisTestConstants.EXTENSIONNAME)
public class TestDataSystemSetup extends AbstractSystemSetup
{
	...
	public void createProjectData(final SystemSetupContext context)
	{
		if (getBooleanSystemSetupParameter(context, CREATE_TEST_DATA))
		{
			...
			importImpexFile(context, "/hybristest/import/qa-test-users.impex");

			LOG.info("Creating Reviews...");
			importImpexFile(context, "/hybristest/import/reviews.impex");
			...
			importImpexFile(context, "/hybristest/import/cstickets.impex");
		}
	}
}
