...
import com.nagarro.core.product.data.ProductDataList;
...
import com.nagarro.core.util.ws.SearchQueryCodec;
...
public class ProductsController extends BaseController
{
	 ...
	 * {@link com.nagarro.core.populator.HttpRequestReviewDataPopulator} to populate review data
			...
			@RequestParam(required = false, defaultValue = MAX_INTEGER) final int pageSize)
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("getProductStockByLocationGeoCode: code=" + sanitize(code) + " | latitude=" + latitude + " | longitude=" + longitude);
		}
		final Set<ProductOption> opts = extractOptions(BASIC_OPTION);
