...
import com.nagarro.core.populator.HttpRequestAddressDataPopulator;
import com.nagarro.core.populator.HttpRequestCustomerDataPopulator;
import com.nagarro.core.populator.options.PaymentInfoOption;
import com.nagarro.core.user.data.AddressDataList;
import com.nagarro.core.user.data.LoginChangeResponse;
import com.nagarro.core.user.data.PasswordRestoreResponse;
import com.nagarro.core.validation.data.AddressValidationData;
...
public class CustomersController extends BaseController
{
	...
	public void updateDefaultAddress(@PathVariable final String id) throws DuplicateUidException
	{
		...
		if (address == null)
		{
			throw new RequestParameterException("Address with given id: '" + sanitize(id) + "' doesn't exist or belong to another user",
