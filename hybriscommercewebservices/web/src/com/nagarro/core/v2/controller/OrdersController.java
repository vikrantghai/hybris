...
import com.nagarro.core.exceptions.PaymentAuthorizationException;
import com.nagarro.core.strategies.OrderCodeIdentificationStrategy;
import com.nagarro.core.v2.helper.OrdersHelper;
...
public class OrdersController extends BaseCommerceController
{
	...
	/**
	 * Returns {@value  com.nagarro.core.v2.controller.BaseController#HEADER_TOTAL_COUNT} header with a total number of results (orders history for all
